...
const Navbar = () => {
  const [active, setActive] = useState(localStorage.getItem("page") || "home");

  return (
    <nav className="nav flexbox">
      <img src={logo} alt="logo" className="logo" />

      <ul className="navigation flexbox">
        <li>
          <Link
            to={"/"}
            onClick={() => {
        ...
        <li>
          <Link
            to={"/tv-series"}
            onClick={() => {
              localStorage.setItem("page", "tv-series");
              setActive("tv-series");
            }}
          >
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              id="tv-series"
              className={active === "tv-series" ? "active" : ""}
            >
        ...
        <li>
          <Link to={"/bookmarks"} onClick={() => {
            localStorage.setItem("page", "bookmarks");
            setActive("bookmarks")}}>
            <svg
              width="17"
              height="20"
